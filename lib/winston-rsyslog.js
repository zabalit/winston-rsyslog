...
Rsyslog.prototype.log = function (level, msg, meta, callback) {
    ...
    let _bufferString = "<" + _pri + ">" + _date + " " + this.tag + " - " + level;
    if (meta['requestId']) {
        _bufferString += " - " + meta['requestId'];
    }
    if (meta['clase']) {
        _bufferString += " - " + meta['clase'];
    }
    if (meta['funcion']) {
        _bufferString += " - " + meta['funcion'];
    }
    _bufferString += " - " + msg;
    _buffer = new Buffer(_bufferString);
